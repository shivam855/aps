...
public class IxigoFlightBookingTest extends BaseTest {
    ...
    public void testFlightBookingFlowFromExcel(Map<String, String> testData) {
        String mobile = testData.get("Mobile");
        String fromQuery = testData.get("FromQuery");
        String fromAirport = testData.get("FromAirport");
        String toQuery = testData.get("ToQuery");
        String toAirport = testData.get("ToAirport");
    ...
    private void runLiveBookingFlow(String mobile, String fromQuery, String fromAirport,
                                    ...
                                    String passengerName, String email) {
